...
--train_datasets \
'{
"MOODPatchesPctileChauhan": {"split": "train", "dset_path": "/home/derek/mood_patches/raw_brain_patches_64.npz"}
}' \
--val_datasets \
'{
    "MOODPatchesPctileChauhan": {"split": "validation", "dset_path": "/home/derek/mood_patches/raw_brain_patches_64.npz", "toy": false, "anom": false},
    "MOODPatchesPctileChauhan": {"split": "validation", "dset_path": "/home/derek/mood_patches/brain_toy_patches_64.npz", "toy": false, "anom": true}
}' \
--model VAE \
