...
--train_datasets \
'{
    "MOODPatchesPctileChauhan": {"split": "train", "dset_path": "/home/derek/mood_patches/coronal_abdom_patches_28.npz"}
}' \
--val_datasets \
'{
    "MOODPatchesPctileChauhan": {"split": "validation", "dset_path": "/home/derek/mood_patches/coronal_abdom_patches_28.npz", "toy": false, "anom": false},
    "MOODPatchesPctileChauhan": {"split": "validation", "dset_path": "/home/derek/mood_patches/coronal_abdom_toy_patches.npz", "toy": false, "anom": true}
}' \
--model VAE \
