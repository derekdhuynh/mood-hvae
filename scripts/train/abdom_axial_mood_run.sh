...
--train_datasets \
'{
    "MOODPatchesPctileChauhan": {"split": "train", "dset_path": "/home/derek/mood_patches/120k_raw_abdom_patches.npz"}
}' \
--val_datasets \
'{
    "MOODPatchesPctileChauhan": {"split": "validation", "dset_path": "/home/derek/mood_patches/120k_raw_abdom_patches.npz", "toy": false, "anom": false},
    "MOODPatchesPctileChauhan": {"split": "validation", "dset_path": "/home/derek/mood_patches/abdom_toy_patches28.npz", "toy": false, "anom": true}
}' \
--model VAE \
